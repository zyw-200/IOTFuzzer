...
extern void loadCPUState(CPUArchState *env, CPUArchState *saved_env);
extern void storeCPUState(CPUArchState *env,  CPUArchState *saved_env);
extern target_ulong pause_stateTransit_wait(CPUState *cpu);
