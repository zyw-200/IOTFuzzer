...
//zyw
	//if(addr == 0x4073c0 || addr == 0x401c70) printf("cpu_ldst_template.h:%x,%x,%x\n", addr,hostaddr,res);
    }
    return res;
}
...
//zyw
        ...
        if(DECAF_is_callback_needed(DECAF_MEM_WRITE_CB)){
            helper_DECAF_invoke_mem_write_callback(ptr, qemu_ram_addr_from_host_nofail((void *)(hostaddr)), (void *)(hostaddr), 0 ,0, 2); //value 0
        }
