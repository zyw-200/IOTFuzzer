<?php
	...
	if (!empty($_REQUEST['writeData'])) {
		if (!empty($_REQUEST['macAddress']) && array_search($_REQUEST['reginfo'],Array('WW'=>'0','NA'=>'1','JP'=>'2'))!==false && ereg("[0-9a-fA-F]{12,12}",$_REQUEST['macAddress'],$regs)!==false) {
...
<html>
	...
	<body align="center">
		<form name="hiddenForm" action="boardDataJP.php" method="post" align="center">
			<div align="center">
			<table align="center" style="margin: 20px; width: 40%; text-align: center; border: 1px solid #46008F">
				...
				<tr>
					...
					<td width="70%">
						<input type="radio" id="reginfo" name="reginfo" value="2" checked="true"><small>Japan (JP)</small>
					</td>
				</tr>
				<tr>
