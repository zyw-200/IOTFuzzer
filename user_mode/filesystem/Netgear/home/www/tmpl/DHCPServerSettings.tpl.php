<?php /* Smarty version 2.6.18, created on 2012-08-27 05:49:30
					...
					<td class="spacer100Percent paddingsubSectionBody" id="DHCPv4">
						<table class="tableStyle">
							...
							<?php if ($this->_tpl_vars['config']['WNDAP330']['status']): ?>
								...
								<?php else: ?>
									<?php $this->assign('onclickStr', "IPgraysomething(this,true,'DHCPv4');"); ?>
								<?php endif; ?>
							<?php else: ?>
								<?php $this->assign('onclickStr', "IPgraysomething(this,true,'DHCPv4');"); ?>
							<?php endif; ?>
							<?php echo smarty_function_input_row(array('label' => 'DHCPv4 Server','id' => 'dhcpServerStatus','name' => "system[dhcpsSettings][dhcpServerStatus]",'type' => 'radio','options' => "1-Enable,0-Disable",'onclick' => ($this->_tpl_vars['onclickStr']),'selectCondition' => "==".($this->_tpl_vars['dhcpServerStatus'])), $this);?>
...
<?php endif; ?>
							<?php echo smarty_function_input_row(array('label' => 'Starting IPv4 Address','id' => 'dhcpsIpStart','name' => "system[dhcpsSettings][dhcpsIpStart]",'type' => 'ipfield','value' => $this->_tpl_vars['data']['dhcpsSettings']['dhcpsIpStart'],'disableCondition' => "1!=".($this->_tpl_vars['dhcpServerStatus']),'validate' => "IpAddress, (( allowZero: false ))^Presence"), $this);?>


							<?php echo smarty_function_input_row(array('label' => 'Ending IPv4 Address','id' => 'dhcpsIpEnd','name' => "system[dhcpsSettings][dhcpsIpEnd]",'type' => 'ipfield','value' => $this->_tpl_vars['data']['dhcpsSettings']['dhcpsIpEnd'],'disableCondition' => "1!=".($this->_tpl_vars['dhcpServerStatus']),'validate' => "IpAddress, (( allowZero: false ))^Presence"), $this);?>
							...
							<?php echo smarty_function_input_row(array('label' => 'Gateway IPv4 Address','id' => 'dhcpsGateway','name' => "system[dhcpsSettings][dhcpsGateway]",'type' => 'ipfield','value' => $this->_tpl_vars['data']['dhcpsSettings']['dhcpsGateway'],'disableCondition' => "1!=".($this->_tpl_vars['dhcpServerStatus']),'validate' => "IpAddress, (( allowZero: false ))^Presence"), $this);?>
