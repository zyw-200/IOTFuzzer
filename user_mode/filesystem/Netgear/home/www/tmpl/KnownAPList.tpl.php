										...
										<tr>
											<td>
												<div  id="BlockContentTable">
                                                                                                        <!-- VVDN Code Starts -->
													<table class="BlockContentTable" id="knownList0">
														<thead>
															<tr>
																<?php echo smarty_function_sortable_header_row(array('sortable' => 'false','tableid' => 'knownList0','rowid' => '0','content' => "#"), $this);?>

																<?php echo smarty_function_sortable_header_row(array('sortable' => 'true','tableid' => 'knownList0','rowid' => '1','content' => 'MAC Address'), $this);?>

																<?php echo smarty_function_sortable_header_row(array('sortable' => 'true','tableid' => 'knownList0','rowid' => '2','content' => 'SSID'), $this);?>

																<?php echo smarty_function_sortable_header_row(array('sortable' => 'true','tableid' => 'knownList0','rowid' => '3','last' => 'true','content' => 'Channel'), $this);?>
                                                                                                                <!-- VVDN Code Ends -->
															</tr>
														</thead>
														<tbody>
									...
									<table class="tableStyle">
										<tr>
											<td>
												<div  id="BlockContentTable">
                                                                                                        <!-- VVDN Code Starts -->
													<table class="BlockContentTable" id="knownList1">
														<thead>
															<tr>
																<?php echo smarty_function_sortable_header_row(array('sortable' => 'false','tableid' => 'knownList1','rowid' => '0','content' => "#"), $this);?>

																<?php echo smarty_function_sortable_header_row(array('sortable' => 'true','tableid' => 'knownList1','rowid' => '1','content' => 'MAC Address'), $this);?>

																<?php echo smarty_function_sortable_header_row(array('sortable' => 'true','tableid' => 'knownList1','rowid' => '2','content' => 'SSID'), $this);?>

																<?php echo smarty_function_sortable_header_row(array('sortable' => 'true','tableid' => 'knownList1','rowid' => '3','last' => 'true','content' => 'Channel'), $this);?>
                                                                                                                <!-- VVDN Code Ends -->
															</tr>
														</thead>
														<tbody>
