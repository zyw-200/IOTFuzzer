...
/* 16 */else if ($name=="(GMT-04:00) Atlantic Time (Canada)")		return "(GMT-04:00) ".i18n("Atlantic Time (Canada)");
/* 17 */else if ($name=="(GMT-04:00) Caracas, La Paz")				return "(GMT-04:00) ".i18n("Caracas, La Paz");
/* 18 */else if ($name=="(GMT-04:00) Santiago")						return "(GMT-04:00) ".i18n("Santiago");
