...
<HTML>
	<HEAD>
		<TITLE>
		<? echo query("/runtime/device/modelname"); ?>
		</TITLE>
	</HEAD>
	<BODY>
	...
	<tr> 
		...
		<td> 
			<table id="___" width="786" height="539" border="0" cellpadding="0" cellspacing="0"> 
				...
				<tr> 
					<td height="35" colspan="7"><font color="#808080" size="6"><font color="#999999" size="6" face="Arial, Helvetica, sans-serif">
					<?echo i18n("The page you requested is not available.");?></font></font></td> 
				</tr> 
				<tr> 
				...
				<tr> 
					...
					<li><?echo i18n("Check to make sure that the");?> <a href="/index.php"><?echo i18n("Internet 	settings");?></a> 
					<li><?echo i18n("on your router are set correctly, such as your PPPoE username/password settings.");?></li> 
