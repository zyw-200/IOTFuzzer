...
function check_apply()
{
	...
	obj.add_param_arg('wlanCfg_Enable_','1.2.0.0',($('#mssid_enable1').attr('checked')?1:0));
	obj.add_param_arg('wlanCfg_ScheduleIndex_','1.2.0.0',$('#ssid_schedule1').val());

	obj.add_param_arg('wlanCfg_SSID_','1.3.0.0',urlencode($('#show_ssid_2').val()));
	obj.add_param_arg('wlanCfg_Enable_','1.3.0.0',($('#mssid_enable2').attr('checked')?1:0));
	obj.add_param_arg('wlanCfg_ScheduleIndex_','1.3.0.0',$('#ssid_schedule2').val());
...
{
	var val_en = lanCfg.enable[1];
	$('#mssid_enable1').attr('checked',val_en=='1');
	var val_en = lanCfg.enable[2];
...
{
	var val_sche = lanCfg.schedule[1];
	$('#ssid_schedule1').val(val_sche);
	var val_sche = lanCfg.schedule[2];
...
{
	if(isWDS[0]=="3" && $('#security_mode1').val() == "WPA2PSK")
	{
						...
						<tr>
							...
							<div id="mainform">
								...
								<div class="header_desc" id="advancedIntroduction">
									<p><script>show_words('_help_txt301')</script></p>
								</div>
