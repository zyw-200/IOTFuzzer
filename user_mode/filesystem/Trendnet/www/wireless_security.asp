...
<script type="text/javascript">
	...
	function send_request()
	{
		...
		var idx = parseInt($('#ssidIndex').val(),10) +1;
		...
		obj.add_param_arg('wlanCfg_MACAction_','1.'+idx+'.0.0',$("#apselect_"+(idx-1)).val());
		...
		if($('#newap_text_'+(idx-1)).val() != "")
			temMAC[temMAC.length++] = $('#newap_text_'+(idx-1)).val();
