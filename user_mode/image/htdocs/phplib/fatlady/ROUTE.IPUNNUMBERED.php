...
function verify_setting($path, $max)
{
	...
	TRACE_debug("FATLADY: ROUTE.IPUNNUMBERED: max=".$max.", count=".$count.", seqno=".$seqno);
...
$max = query("/route/ipunnumbered/max"); if ($max=="") $max=32;
if (verify_setting($FATLADY_prefix."/route/ipunnumbered", $max)=="OK")
{
