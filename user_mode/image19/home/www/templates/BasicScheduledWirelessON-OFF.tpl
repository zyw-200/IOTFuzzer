				...
				<tr>
					...
					<td class="spacer100Percent paddingsubSectionBody">
						...
						<tr><td>
							...
							{input_row label="Scheduled Wireless on-off" id="schWirelessonoff" name=$parentStr.basicSettings.scheduledWirelessStatus type="radio" options="1-On,0-Off" selectCondition="==$scheduledWirelessStatus" onclick="$onclickStr;disableSchduleControls(this)"}
							</td>
						<tr>
							...
							<tr>
								...
								<td class="DatablockContent">
									&nbsp&nbsp<input class="input" size="2" maxlength="2" id="radioOnHour" label="Radio ON Hour" value="" type="text" onblur="convert2TimeString()" validate="Numericality, {literal}{ minimum:0, maximum: 23, onlyInteger: true }^Presence"{/literal} onkeydown="setActiveContent();" {if $scheduledWirelessStatus eq '0'}disabled="disabled"{/if}>&nbsp:
