					...
					<td class="spacer100Percent paddingsubSectionBodyLogin">
						<table class="padding5Top tableStyle">
							<tr>
								...
								<td class="spacer55Percent" align="left"><input type='text' class="input"  name="username" id="username" maxlength="48" label="User Name" validate="Presence, {literal}{ onlyOnSubmit: true }{/literal}"></td>
							</tr>
							<tr>
								<td class="font10Bold padding4Top" align="left">Password</td>
								<td class="padding4Top" align="left"><input type='password' class="input"  name="password" id="password" maxlength="64" label="Password" validate="Presence, {literal}{ onlyOnSubmit: true }{/literal}"></td>
							</tr>
							<tr>
