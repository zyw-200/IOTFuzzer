<?php /* Smarty version 2.6.18, created on 2012-06-07 11:14:36
         compiled from SNMP.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'input_row', 'SNMP.tpl', 13, false),array('modifier', 'replace', 'SNMP.tpl', 22, false),)), $this); ?>
	<tr>
		<td>	
				...
				<tr>
					...
					<td class="spacer100Percent paddingsubSectionBody">
						<table class="tableStyle">	
							...
							<?php echo smarty_function_input_row(array('label' => 'IP Address to Receive Traps','id' => 'trapServerIP','name' => $this->_tpl_vars['parentStr']['remoteSettings']['trapServerIP'],'type' => 'ipfield','value' => ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['data']['remoteSettings']['trapServerIP'])) ? $this->_run_mod_handler('replace', true, $_tmp, '0.0.0.0', '') : smarty_modifier_replace($_tmp, '0.0.0.0', '')))) ? $this->_run_mod_handler('replace', true, $_tmp, '-', ':') : smarty_modifier_replace($_tmp, '-', ':')),'disableCondition' => "0==".($this->_tpl_vars['snmpStatus']),'masked' => 'true','onchange' => "this.setAttribute('masked',(this.value != '')?false:true)",'validate' => "IpAddress, (( allowZero: false, allowIpV6: true ))"), $this);?>
