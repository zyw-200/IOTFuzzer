...
*/
	...
	else if(network_read_block == 1 && pc == 0x400308){
...
/*
	if(index == 0){
		if(pc >= 0x411910 && pc <= 0x411f7c)//.MIPS.stubs for single_httpd_sample
			return;
	}
*/
//
