...
#ifdef CONFIG_SOFTMMU /* AWH - For callbacks */
...
{
#ifdef CONFIG_SOFTMMU /* AWH - callback */
	TranslationBlock *tb;
	tb = ctx->tb;
...
#ifdef CONFIG_SOFTMMU /* AWH - based off of the I386 target approach */
