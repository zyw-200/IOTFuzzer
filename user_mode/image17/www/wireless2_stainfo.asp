...
<script type="text/javascript">
	...
	main.add_param_arg('IGD_WLANConfiguration_i_WLANStatus_Client_i_',1510);
	main.add_param_arg('IGD_WLANConfiguration_i_WLANStatus_Client_i_',1610);
	main.add_param_arg('IGD_WLANConfiguration_i_WLANStatus_Client_i_',1710);
	main.add_param_arg('IGD_WLANConfiguration_i_WLANStatus_Client_i_',1810);
	...
	<td>
		...
		<tr>
			...
			<td style="background-image:url('/image/bg_l.gif');background-repeat:repeat-y;vertical-align:top;" width="270">
				...
				<script>document.write(menu.build_structure(1,3,5))</script>
				<p>&nbsp;</p>
				</div>
