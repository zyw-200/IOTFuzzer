<?
$wpa_supplicant_conf 	= "/var/run/wpa_supplicant.".$wlanif_a.".conf";
//$wpa_supplicant_pid    = "/var/run/wpa_supplicant.".$wlanif_a.".pid";
$encrtype		= query("/wlan/inf:2/wpa/wepmode");
$wepdefkey 		= query("/wlan/inf:2/defkey");
$wepkeyformat 		= query("/wlan/inf:2/wepkey:".$wepdefkey."/keyformat");
$wepkey1		= query("/wlan/inf:2/wepkey:1");
$wepkey2		= query("/wlan/inf:2/wepkey:2");
$wepkey3		= query("/wlan/inf:2/wepkey:3");
$wepkey4		= query("/wlan/inf:2/wepkey:4");
