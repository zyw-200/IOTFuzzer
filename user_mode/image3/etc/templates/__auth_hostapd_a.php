<?
/* vi: set sw=4 ts=4: */
$HAPD_interface	= $wlanif_a;
$HAPD_bridge	= "br0";
$HAPD_conf	= "/var/run/hostapd.".$HAPD_interface.".ap_bss";
$authtype	= query("/wlan/inf:2/authentication");
$encrtype	= query("/wlan/inf:2/wpa/wepmode");
$Rport		= query("/wlan/inf:2/wpa/radiusport");
$Rhost		= query("/wlan/inf:2/wpa/radiusserver");
$Rsecret	= query("/wlan/inf:2/wpa/radiussecret");
$BackupRport	= query("/wlan/inf:2/wpa/b_radiusport");
$BackupRhost	= query("/wlan/inf:2/wpa/b_radiusserver");
$BackupRsecret	= query("/wlan/inf:2/wpa/b_radiussecret");
...
$Aenable	= query("/wlan/inf:2/wpa/acctstate");
$Aport		= query("/wlan/inf:2/wpa/acctport");
$Ahost		= query("/wlan/inf:2/wpa/acctserver");
$Asecret	= query("/wlan/inf:2/wpa/acctsecret");
$BackupAport	= query("/wlan/inf:2/wpa/b_acctport");
$BackupAhost	= query("/wlan/inf:2/wpa/b_acctserver");
$BackupAsecret	= query("/wlan/inf:2/wpa/b_acctsecret");
$wpapsk		= query("/wlan/inf:2/wpa/wpapsk");
$wpapskformat	= query("/wlan/inf:2/wpa/passphraseformat");
$rkeyint	= query("/wlan/inf:2/wpa/grp_rekey_interval");
$ssid		= query("/wlan/inf:2/ssid");
$DyWepKeyLen	= query("/wlan/inf:2/d_wepkeylen");
$DyWepRKeyInt	= query("/wlan/inf:2/d_wep_rekey_interval");
...
if(query("/wlan/inf:2/autorekey/ssid/enable")==1 && query("/runtime/wlan/inf:2/wpa/wpapsk")!="")//add for autorekey by log luo
{
        $wpapsk     = query("/runtime/wlan/inf:2/wpa/wpapsk");

}
else if(query("/wlan/inf:2/wpa/wpapsk")!="")
{
$wpapsk         = query("/wlan/inf:2/wpa/wpapsk");
}
else
...
if ($HAPD_wpa > 0)
{
	...
	else
	{
		...
		if(query("/wlan/inf:2/autorekey/ssid/enable")==1)   {$wpapskformat = 1;}
