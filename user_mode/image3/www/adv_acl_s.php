...
{
	var f = get_obj("frm");
	self.location.href = "adv_acl_s.php?band_reload=" + s.value;
}
...
<!-- ________________________________ Main Content Start ______________________________ -->
			<table id="table_set_main"  border="0"<?=$G_TABLE_ATTR_CELL_ZERO?>>
				<tr>
					...
					<td id="td_right"><?=$G_TAG_SCRIPT_START?>genSelect("band", [0,1], ["<?=$m_band_2.4G?>","<?=$m_band_5G?>"], "on_change_band(this);");<?=$G_TAG_SCRIPT_END?></td>
				</tr>
				<tr>
					<td id="td_left">
						<?=$m_acl_type?>
