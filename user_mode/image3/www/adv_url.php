...
$cfg_url_enable = query("/wlan/inf:1/webredirect/enable");
...
function submit()
{
	...
	{
		if(r_list.length==1 && f.url_enable.checked==true )
		{
			alert("<?=$a_at_least_1_acc_enable?>");	
		}
		else
		{
			...
			if(any_enabled > 0 || f.url_enable.checked==false)
			{
		f.action.value="save";
...
<!-- ________________________________ Main Content Start ______________________________ -->
      		...
      		<tr>
      			<td width="27%"><?=$m_enable_url?></td>
      			<td><?=$G_TAG_SCRIPT_START?>genCheckBox("url_enable","");<?=$G_TAG_SCRIPT_END?>
				</td>
      		</tr>
      		<tr>
      			<td colspan="2">
